const GOOGLE_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbwjlTLXWkP-pP5IRqzrOcDE5CXLP8JP_xd6sTbfDoUp2MZ8JA2TMHwwLGtfKwgt9jwPqA/exec';
...
function checkSession() {
    const savedUser = localStorage.getItem('cox_session');
    if (savedUser) {
